...
import hearsilent.kuas.food.base.App;
import hearsilent.kuas.food.gl.RawResourceReader;
import hearsilent.kuas.food.gl.ShaderHelper;
...
public class ParticleSystemRenderer implements GLSurfaceView.Renderer {
	...
	public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
		...
		final String vertexShader =
				RawResourceReader.readTextFileFromRawResource(App.getAppContext(), R.raw.star_vert);
		final String fragmentShader =
				RawResourceReader.readTextFileFromRawResource(App.getAppContext(), R.raw.star_frag);
