...
public class SplashActivity extends AppCompatActivity {
	...
	private void setUpDB() {
		...
		addData("金飯統便當", "高雄市建工路711號", 22.647688, 120.31666799999994, "建工", "午餐、晚餐", "無",
				...
				"");
		addData("滷味鮮湯滷味", "高雄市三民區立忠路31號", 22.6530742, 120.32567549999999, "建工", "午餐、晚餐", "無",
		...
		addData("元氣早午餐", "高雄市三民區新民路86號", 22.652202, 120.32388600000002, "建工", "早午餐", "無",
				...
				"");
		addData("義式創意廚坊", "高雄市三民區大昌二路514號", 22.6514538, 120.33060130000001, "建工", "午餐、晚餐", "無",
		...
		addData("原鄉牛肉麵", "高雄市三民區大昌二路481號", 22.6505576, 120.33124610000004, "建工", "午餐、晚餐", "無",
				"丹丹漢堡旁邊水餃一顆3塊 爽",
		...
		addData("39焗烤家族", "高雄市三民區大昌二路551號", 22.6518354, 120.32972569999993, "建工", "午餐、晚餐", "無",
				"提供義大利麵、焗烤、比薩、異國咖哩排餐、雞腿堡餐、焗烤厚片、雞塊、薯條", "無", "");
		addData("燈籠滷味", "高雄市三民區大昌二路511號", 22.651125, 120.3304253, "建工", "午餐、晚餐", "無", "好吃的滷味", "無",
				"");
		addData("赤印牛排", "高雄市三民區明誠一路443號", 22.6602182, 120.32151010000007, "建工", "午餐、晚餐", "無",
				"平價但一點都不馬虎，麵粉經過拌炒後，加入碎肉及玉米，敖煮出濃濃奶香的玉米濃湯，還有爆漿餐包及古早味紅茶，都是店內的招牌",
				"http://ext.pimg.tw/julialkpkpk/1421747284-4071200878.jpg", "");
		addData("鮮焗家", "高雄市三民區大昌一路38號", 22.6531206, 120.32766670000001, "建工", "午餐", "無", "焗烤", "無",
				"");
		addData("幽靈香腸", "高雄市三民區河北二路130號", 22.635394, 120.294318, "建工", "宵夜", "無",
				"不錯吃，營業時間非常不固定，請賭運氣在2330～0000間到三鳳宮看看", "無", "");
		addData("胖叔叔拉麵店", "高雄市三民區正忠路502號", 22.6507438, 120.33093459999998, "建工", "午餐、晚餐", "無",
				"超級好吃的拉麵店", "無", "");
		addData("正中食堂", "高雄市三民區正忠路494號", 22.6506157, 120.33084280000003, "建工", "午餐、晚餐", "無",
				"超好吃的泰式拋肉飯 吃完總是讚不絕口", "無", "");
		addData("啊懷傳家河粉麵，飯", "高雄市三民區正忠路359號", 22.648126, 120.32986400000004, "建工", "午餐、晚餐", "無",
				"新開的店 河粉好吃！", "無", "");
		...
		addData("禾記嫩骨飯", "高雄市大社區中山路485號", 22.7310453, 120.35454589999995, "燕巢", "午餐、晚餐", "無",
				"(07) 354 2088", "無", "073542088");
		addData("真美香台日食堂", "高雄市大社區中山路410號", 22.7312672, 120.35266219999994, "燕巢", "午餐、晚餐", "無",
				"(07) 352 3772", "無", "073523772");
		addData("八方雲集", "高雄市燕巢區中民路704號", 22.7932222, 120.35931470000003, "燕巢", "午餐、晚餐", "無",
				"(07) 353 4868", "無", "073534868");
		addData("大社第一家土魠魚羹", "高雄市大社區中山路410號", 22.7312672, 120.35266219999994, "燕巢", "午餐、晚餐", "無",
				"0970 412 513 羹飯麵偏少更新45、55，服務好", "無", "0970412513");
		...
		addData("悟饕池上飯包", "高雄市燕巢區中民路586號", 22.7932965, 120.36244439999996, "燕巢", "午餐、晚餐", "無",
				"(07) 614 2977", "無", "076142977");
	}

	private void addData(String name, String address, double lat, double lng, String region,
	...
	private List<ShopModel> getData() {
		return DataSupport.findAll(ShopModel.class);
	}
